...
The `/agents` route shows live Claude Code sessions and their transcript tails. See [[Agent sessions]] for the CLI examples, supported AI tools, and privacy notes.
