...
// maps to "dist/assets/app.js". This is the ONLY frontend track serves: a released/Nix binary carries
// the real build, a plain `go build` carries the placeholder. To iterate on the frontend, use the Vite
// dev server (`cd web && npm run dev`), which proxies /api to a running `track web`.
