...
reports, task worklogs, and vault maintenance. They used to ship from this repository as the `track`
plugin; they moved out so they can change on an agent-workflow cadence instead of the CLI's release
cycle.
